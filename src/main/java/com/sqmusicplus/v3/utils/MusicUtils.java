...
public class MusicUtils {
    ...
    public static synchronized void setMediaFileInfo(File file, String title, String albumName, String artists, String comment, String lyrics, File image, String mainArtist, String albumYear) {
        try {
