...
/**
 * @Classname MgAlbumInfoResult2
 * @Description TODO
 * @Date 2026/4/25 09:24
 * @Created by SQ
 */
@NoArgsConstructor
@Data
public class MgAlbumInfoResult2 {
    ...
    public static class ResourceDTO {
        ...
        public static class OpNumItemDTO {
            ...
            @JsonProperty("callingPlayDefaultNum")
            private Integer callingPlayDefaultNum;
            @JsonProperty("callingPlayDefaultNumDesc")
            private String callingPlayDefaultNumDesc;
            @JsonProperty("playDefaultNum")
            private Integer playDefaultNum;
            @JsonProperty("playDefaultDesc")
            private String playDefaultDesc;
            @JsonProperty("rewardUserNum")
            private Integer rewardUserNum;
            @JsonProperty("rewardUserNumDesc")
            private String rewardUserNumDesc;
            @JsonProperty("rewardTotalNum")
            private Integer rewardTotalNum;
            @JsonProperty("rewardTotalNumDesc")
            private String rewardTotalNumDesc;
            @JsonProperty("aiSongTotalNum")
            private Integer aiSongTotalNum;
            @JsonProperty("aiSongTotalNumDesc")
            private String aiSongTotalNumDesc;
        }
